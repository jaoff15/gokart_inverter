...
HD_PWD='/home/jonas/Documents/SDU/Master/Semester 1/Project/software/git/gokart_inverter/inverterControl/inverterControl.runs/block_adc_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_adc_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_adc_rst_ps7_0_100M_0.tcl
